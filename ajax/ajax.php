...
ini_set('error_log', dirname(__FILE__) . '/error_log.txt');  
    ...
    switch($type){
    	case 'video':
                ...
                echo '<li class="col-xs-6 col-sm-6 col-md-4 col-lg-4" ><a href="./yt.php?v='.$v["id"]["videoId"].'" target="_black" class="hhh" title="'.$v["snippet"]["title"].'" >
    ...
    echo '<li class="col-xs-6 col-sm-6 col-md-4 col-lg-4" ><a href="./yt.php?v='. $value['id'].'" class="hhh" >
    ...
    echo '</ul>';
      ...
      <div class="media-body col-8 chaneelit">
        ...
        echo ' <div class="media height1 py-3 pt-3">
    		...
    		<a href="./yt.php?v='. $v['id']['videoId'].'" target="_blank" class="d-block" style="position:relative">
    		...
    		<div class="media-body pl-2"  style="width:70%;max-width:70%;">
    			<h5 class="media-heading listfont">
    				<a href="./yt.php?v='. $v['id']['videoId'].'" target="_blank" class="font30" title="'.$v["snippet"]["title"].'">'.$v["snippet"]["title"].'</a>
    			</h5>
    ...
    break;
     ...
     foreach($related["items"] as $v) {
       echo'<div class="media height1">
    		...
    		<a href="./yt.php?v='.$v["id"]["videoId"].'" >
    		<img src="./thumbnail.php?type=mqdefault&vid='.$v["id"]["videoId"].'" width="100%">
    		</a>
    		</div>
    		<div class="media-body pl-2">
    			<h5 class="media-heading height2">
    				<a href="./yt.php?v='.$v["id"]["videoId"].'" class="text-dark">'.$v["snippet"]["title"].'</a>
    			</h5>
    ...
    echo '<li class="col-xs-6 col-sm-6 col-md-4 col-lg-4" ><a href="./yt.php?v='. $v["id"].'" class="hhh" >
...
';
  ...
  <p class="mb-0">本站使用cookies临时存储您的历史记录在您的浏览器上，本站不会对您的观看历史进行保存，仅记录您的最后30条浏览记录，若您清理过你的浏览器cookies，将无法恢复！</p>
                ...
                echo '<div class="media height1 py-3 pt-3 ">
    		<div class="media-left" style="width:30%;min-width:30%;">
    		<a href="./yt.php?v='.$v['id'].'" target="_blank" class="d-block" style="position:relative">
    		...
    		<div class="media-body pl-2"  style="width:70%;max-width:70%;">
    			<h5 class="media-heading listfont">
    				<a href="./yt.php?v='.$v['id'].'" target="_blank" class="font30">'.$v["snippet"]["title"].'</a>
    			</h5>
    ...
    echo '<li class="col-xs-6 col-sm-6 col-md-4 col-lg-4" ><a href="./yt.php?v='. $v['id']['videoId'].'" class="hhh" >
